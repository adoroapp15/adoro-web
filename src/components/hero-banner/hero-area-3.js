...
const HeroAreaThree = () => {
  ...
  const handleDownload = async (e, link) => {
    const confirmed = window.confirm('Do not worry , we promise our app would not bite ! It is as harmless as a kitten playing with a ball of yarn.🐱');
    if (confirmed) {
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6">
              ...
              >
                <h2 className="title">Get Better {'\n'} Together</h2>
                <p className="desc">
                aiming to build a community that empowers creators and their creativity, beyond all boundaries.
                </p>
                <a
                  href="#"
                  onClick={(e) => 
