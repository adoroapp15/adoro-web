    ...
    <section className="fact-area fact-style-three section-pt-60 section-pb-30">
      <div className="container">
        <div className="fact__items-wrap position-relative">
          ...
          >
            <SingleFactItem count="15+" meta="Brands collabs" />
            <SingleFactItem count="100+" meta="Campaigns Live" />
            <SingleFactItem count="500+" meta="Creative artists" />
            <SingleFactItem count="2.5x" meta="Increased Earning" />
